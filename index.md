...
The challenge provides a standard dataset of implicit feedback focused in the fields of Health and Chemistry, specially developed from a corpus of documents related to COVID-19 disease (https://forms.gle/Bik6h6Zz62HG3YxYA). The items in the dataset are diseases from the Disease Ontology (DO) and chemical compounds from the Chemical Entities of Biological Interest ontology (CHEBI), with correspondence to the DrugBank. The goal of the participants will be, given a set of users with a set of items ordered sequentially, to provide a ranked list with the possibilities of the next item for each one of those users.
...
![FCT](https://www.google.com/url?sa=i&url=http%3A%2F%2Fwww.centrodehistoria-flul.com%2Fprojectos-fct&psig=AOvVaw111wK-08huOGsa-GiGeaZU&ust=1619624164232000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLCBtargnvACFQAAAAAdAAAAABAD)

![lasige](https://www.google.com/url?sa=i&url=http%3A%2F%2Fwww.centrodehistoria-flul.com%2Fprojectos-fct&psig=AOvVaw111wK-08huOGsa-GiGeaZU&ust=1619624164232000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCLCBtargnvACFQAAAAAdAAAAABAD)